            ...
            <div class="px-4 py-4 sm:py-4 sm:px-4 md:px-6 md:py-6 lg:px-8 lg:py-8">
                ...
                <div>
                    ...
                    <li>
                        ...
                        rel="noreferrer"
                        target="_blank"
                        class="text-amber-500 transition hover:text-amber-500/75"
                        >
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                    ...
                    <p class="text-lg font-medium text-amber-500">Our Products</p>
                    ...
                    <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-amber-500">Helpful Links</p>
                    ...
                    <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-amber-500">Contact Us</p>
                ...
                <div class="text-center sm:flex sm:justify-between sm:text-left">
                    ...
                    <a
                        class="inline-block text-amber-500 underline transition hover:text-amber-500/75"
                        href="#"
                    >
                        Terms & Conditions
                    </a>
