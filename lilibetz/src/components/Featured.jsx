    ...
    return (
        <div>
            ...
            <div className="mx-8 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                <a href="#" className="col-span-1 group block overflow-hidden">
                    <div className="relative h-[350px] sm:h-[450px]">
                        ...
                        alt=""
                        className="rounded-lg absolute inset-0 h-full w-full object-cover opacity-100 group-hover:opacity-0"
                        />
