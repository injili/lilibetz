...
function Hero() {
    return (
        <motion.div variants={banner} initial="initial" animate="animate" className=' text-zinc-100 h-screen'>
            <div className="flex aspect-0 flex-col absolute inset-0 justify-center ">
                <div className="flex px-4 lg:px-24 flex-wrap gap-y-4 md:gap-x-24 items-center">
                    <motion.span variants={fromLeft} className="font-b leading-none lg:text-[200px] text-7xl font-bowldyOneSC">bespoke</motion.span>
                ...
                <motion.div variants={fromLeft} className="z-10 relative flex overflow-x-hidden overflow-y-hidden">
                    <div className="py-0 animate-marquee whitespace-nowrap">
                        <span className=" font-bowldyOneSC leading-none lg:text-[230px] text-7xl md:mx-24 mx-8">interior</span>
                        <span className=" font-bowldyOneSC leading-none lg:text-[230px] text-7xl md:mx-24 mx-8">interior</span>
                        <span className=" font-bowldyOneSC leading-none lg:text-[230px] text-7xl md:mx-24 mx-8">interior</span>
                        <span className=" font-bowldyOneSC leading-none lg:text-[230px] text-7xl md:mx-24 mx-8">interior</span>
                        <span className=" font-bowldyOneSC leading-none lg:text-[230px] text-7xl md:mx-24 mx-8">interior</span>
                ...
                <div className="flex md:justify-center items-center lg:gap-44 mx-4"> 
                        ...
                        <motion.span variants={fromLeft} className="font-bowldyOneSC leading-none lg:text-[230px] text-7xl">decor</motion.span>
                </div>
            </div>
            <motion.div variants={fromRight} className="flex flex-col w-4 absolute my-12 bottom-8 right-8 block lg:hidden">
                    <motion.p 
                        whileHover={{ scale: 1.2 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }}
