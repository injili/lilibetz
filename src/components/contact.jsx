                ...
                <div className="lg:col-span-3 flex justify-center lg:my-24 pb-24 px-8 lg:mr-24">
                    <div className="md:grid md:grid-cols-2 md:gap-12">
                        <div className="grid md:grid-rows-5  gap-8 md:gap-12 pb-8 md:pb-0">
                            <div className="row-span-3 hover:shadow-teo shadow-neo flex flex-col items-start justify-center rounded-[25px] px-4 md:px-12 py-4">
                            ...
                            <div className="row-span-2 hover:shadow-teo shadow-neo flex flex-col items-start justify-center rounded-[25px] px-4 md:px-12 py-4">
