        ...
        <div className="p-4">
            <nav>
                <ul className="flex flex-nowrap sm:gap-2 md:gap-8 lg:gap-10 xl:gap-18 2xl:gap-24 justify-center items-center">
                    ...
                    <li className="sm:text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-4xl font-semibold px-8"><span className="text-amber-400 font-pacifico font-medium">Lilibetz</span>  FURNITURE</li>
