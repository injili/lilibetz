...
export const Hero = () =>{
    return (
        <div className='relative'>
            <div className="mx-4 px-4 h-[70vh] flex grid grid-cols-2 gap-8">
                <div>
                    <p className="text-lg text-neutral-500 font-extralight">Transform and Redisign Your Home</p>
                    <p className="py-4 text-8xl font-thin">Discover <span className="font-normal">Your Perfect Seat</span></p>
